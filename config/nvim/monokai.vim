...
" }}}
" {{{ Italics
  let g:oceanic_next_terminal_italic = get(g:, 'oceanic_next_terminal_italic', 1)
  let s:italic = ""
...
"}}}
" {{{ Bold
  let g:oceanic_next_terminal_bold = get(g:, 'oceanic_next_terminal_bold', 1)
  let s:bold = ""
...
" {{{ Colors
  ...
  let s:base02 = ['#49483e', '240']
  let s:base03 = ['#65737e', '243']
  let s:base04 = ['#a7adba', '145']
  let s:base05 = ['#c0c5ce', '251']
  let s:base06 = ['#cdd3de', '252']
  let s:base07 = ['#d8dee9', '253']
  let s:base08 = ['#f6aa11', '253']
  let s:red    = ['#ec5f67', '203']
  let s:orange = ['#ae81ff', '209']
  let s:yellow = ['#66d9ef', '221']
  let s:green  = ['#e6d874', '114']
  let s:cyan   = ['#62b3b2', '73']
  let s:blue   = ['#a6e22e', '68']
  let s:purple = ['#f92672', '176']
...
" {{{ call s::hi(group, fg, bg, gui, guisp)
  ...
  call s:hi('Boolean',                            s:orange, '',       s:italic,          '')
  ...
  call s:hi('StorageClass',                       s:yellow, '',       s:italic,          '')
  call s:hi('String',                             s:green,  '',       '',          '')
  call s:hi('Structure',                          s:yellow, '',       s:italic,          '')
  call s:hi('Tag',                                s:yellow, '',       s:italic,          '')
  call s:hi('Todo',                               s:yellow, s:base01, '',          '')
  call s:hi('Type',                               s:yellow, '',       s:italic,          '')
  call s:hi('Typedef',                            s:purple, '',       '',          '')
  ...
  call s:hi('htmlTag',                            s:white,   '',       '',          '')
  call s:hi('htmlEndTag',                         s:white,   '',       '',          '')
  ...
  call s:hi('PythonBoolean',                            s:orange, '',       '',          '')
  call s:hi('pythonBuiltinFunc',                     s:yellow, '',       '',          '')
  call s:hi('pythonCl',                     s:yellow, '',       s:italic,          '')
  call s:hi('pythonClassVar',                     s:base08, '',       s:italic,          '')
  call s:hi('pythonClass',                     s:white, '',       '',          '')
  call s:hi('pythonCoding',                     s:base03, '',       s:italic,          '')
  call s:hi('pythonDecorator',                     s:purple, '',       '',          '')
  call s:hi('pythonDef',                     s:yellow, '',       s:italic,          '')
  call s:hi('pythonDocTest',                     s:base03, '',       '','')
  call s:hi('pythonDocTest2',                     s:base03, '',       '',          '')
  call s:hi('pythonDottedName',                     s:yellow, '',       '',          '')
  call s:hi('pythonException',                     s:purple, '',       '',          '')

  call s:hi('pythonFunction',                     s:blue, '',       '',          '')
  call s:hi('pythonFunctionCall',                     s:yellow, '',       '',          '')
  call s:hi('pythonLambda',                     s:yellow, '',       s:italic,          '')
  call s:hi('pythonOperator',                     s:purple, '',       '',          '')
  call s:hi('pythonString',                     s:green, '',       '',          '')
  call s:hi('pythonSpaceError',                     s:purple, '',       '',          '')
